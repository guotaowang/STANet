...
### *V<sub>2</sub>*-Weakly Supervised Visual-Auditory Saliency Detection with Multigranularity Perception ([arxiv](https://arxiv.org/abs/2112.13697)), pdf:[V<sub>2</sub>](https://arxiv.org/abs/2112.13697)
...
**Visual**:`net = torch.hub.load('facebookresearch/WSL-Images','resnext101_32x8d_wsl')`      
